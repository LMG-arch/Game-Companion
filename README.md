...
- 2026-06-07：阶段 8 完成 — 设置系统（完整配置面板/7个分类/配置持久化/导入导出）
- 2026-06-07：阶段 7 完成 — 搜索系统（DuckDuckGo 免费搜索/SearXNG 自托管/AI 回答整合）
- 2026-06-07：阶段 6 完成 — 弹幕引擎（队列管理/轨道系统/密度控制/优先级队列/历史记录）
- 2026-06-07：阶段 5 完成 — 人格系统（6套预设/LLM生成/编辑器/切换/持久化）
- 2026-06-07：阶段 4 完成 — 记忆系统（SQLite存储/向量检索/重排/三关写入/三阶段召回/自动维护/降级链路）
- 2026-06-07：阶段 3 完成 — 屏幕捕获（dxcam/变化检测/静默降频）+ AI 视觉分析（多 Provider 支持/场景判断）
- 2026-06-07：阶段 2 完成 — Electron UI 核心（工具栏/侧边栏/气泡/弹幕层/输入框/点击穿透/快捷键），修复窗口闪烁和崩溃问题
